...
class scrapService {
    ...
    create(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield db.scrapModel.create(payload);
            }
            catch (error) {
                throw error;
            }
    ...
    update(query, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield db.scrapModel.findOneAndUpdate(query, payload, { new: true });
            }
            catch (error) {
                throw error;
            }
    ...
    findOne(query) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield db.scrapModel.findOne(query);
            }
            catch (error) {
                throw error;
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    var data = yield db.scrapModel.aggregatePaginate(myAggregate, option);
                    resolve(data);
                }
                catch (error) {
                    reject(error);
...
exports.ScrapService = new scrapService();
