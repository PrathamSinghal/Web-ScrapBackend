...
exports.fetchScrapData = exports.scrapData = void 0;
...
'i');
exports.scrapData = [
    (0, express_validator_1.check)('webUrl').notEmpty().withMessage(responseMessage_1._infoMessaage.required()).matches(urlPattern).
        withMessage('Enter a valid Web Url'),
];
exports.fetchScrapData = [
    (0, express_validator_1.param)('id').notEmpty().withMessage(responseMessage_1._infoMessaage.required()).custom((value) => __awaiter(void 0, void 0, void 0, function* () {
        return scrap_service_1.ScrapService.findOne({ _id: value }).then((data) => {
            if (!data)
