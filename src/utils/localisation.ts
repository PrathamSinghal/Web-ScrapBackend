...
export let languagesMessage =(lang:any,key:any)=>{
    console.log(lang)
    if(!lang) return languages["en"][key];
    
    console.log({lang,key},languages[lang][key])
    return languages[lang][key]
}

export let languagesMsgFunc=(lang)=>{
    return LanguageFunc[lang]
